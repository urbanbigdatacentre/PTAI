...
<!-- The details of the methods employed are provided [Section 2](#Methods). -->
...
```{r}
# Read summary
destination_source <- read_csv('supplemet//destination_sources_pdf.csv')
# Exclude notes
...
acces_out[,-1] %>% 
  kbl(
    caption = 'Accessibility indicators', 
